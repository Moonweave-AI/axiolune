> **SUPERSEDED / WITHDRAWN ¡ª DO NOT CITE AS COMPLETE OR APPROVED**
> Round-3 (2026-07-30): archived under `releases/superseded/`. See `releases/superseded/README.md`.
# ADR-014: M2 Release Governance and Compatibility Framework

**Status**: Proposed  
**Date**: 2026-07-30  
**Context**: E7 (Release governance) â€?M2 v0.1.0 preparation  
**Upstream**: ADR-013 (M2 Authoring Profile), M2-PLAN Â§13 E7
...
- **Semantic chains**: Complete Slice A (Instrument â†?Price â†?Valuation), Slice B (Order â†?Execution â†?Position), Research-to-Execution, Market-to-Risk, Trade-to-Operations
...
- Changing an optional attribute to required (minCount: 0 â†?1)
...
4. **Submit for approval**:
   ...
   - Request governance approval â†?mark as `approved`

---

## References

- M2-PLAN Â§13 E7 (Release governance)
