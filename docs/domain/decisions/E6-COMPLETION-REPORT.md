...
- **Signal as intermediate artifact**: Factor/strategy → Signal → Order (research to execution pipeline)
...
- ✅ Foundation layer (foundation, market-structure, market-rules, instruments)
- ✅ Market data layer (market-data)
- ✅ Portfolio layer (portfolio-positions)
- ✅ Trading layer (orders-execution)
- ✅ Research layer (strategy-research)
- ✅ Risk layer (risk)
- ✅ Operations layer (post-trade-operations)
...
**Slice A** (Instrument → Market-data → Portfolio): ✅ Complete  
**Slice B** (Order → Execution → Position): ✅ Complete  
**Extended chains**:
- Factor → Signal → Order → Execution (research to execution)
- Price → Valuation → Risk Exposure → Limit Breach (market to risk)
- Execution → Settlement → Reconciliation (trade to operations)
...
market-structure, instruments
  ↓
market-rules, market-data
  ↓
portfolio-positions ← orders-execution
  ↓                      ↓
strategy-research    post-trade-operations
  ↓
risk
```
...
1. **Research to Execution**:
   - FactorDefinition → Signal → OrderIntent → OrderLifecycleEvent → Execution

2. **Market to Risk**:
   - PriceObservation → PositionValuation → ExposureObservation → LimitBreach

3. **Trade to Operations**:
   - Execution → SettlementInstruction → ReconciliationBreak

4. **Corporate Actions to Portfolio**:
   - CorporateActionEvent → (affects) FinancialInstrument → HoldingSnapshot
...
|---|---|---|
| G0 (Authoring Profile) | ✅ Complete | ADR-013, validate-m2-core passing for all 10 modules |
| G1 (Foundation/Market/Instrument) | ✅ Complete | 7 modules with full evidence workbench |
| G2 (Market-data + PIT) | ✅ Complete | PIT validator passing, three-axis semantics validated |
| G3 (Portfolio/Positions + Slice A) | ✅ Complete | Price → Holding → Valuation chain validated |
| G4 (Orders/Execution + Slice B) | ✅ Complete | Order → Execution → Position chain validated |
| G5 (Strategy/Risk/Post-trade) | ✅ **Complete** | All 3 modules delivered with evidence |
| G6 (Release) | ⏳ Pending | E7 deliverable |

### Epic Status

| Epic | Status | Deliverable |
|---|---|---|
| E0 | ✅ Complete | M2 compilation base |
| E1 | ✅ Complete | Evidence workbench |
| E2 | ✅ Complete | Foundation/Market/Instrument modules |
| E3 | ✅ Complete | Market-data + PIT validator |
| E4 | ✅ Complete | Portfolio/Positions (Slice A) |
| E5 | ✅ Complete | Orders/Execution (Slice B) |
| E6 | ✅ **Complete** | Strategy/Research, Risk, Post-trade |
| E7 | ⏳ Next | Release governance |
